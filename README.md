...
Cite the edition by its URL. It carries no DOI: the archived deposit was
withdrawn from the edition's public face on 2026-08-08, no further deposits are
made, and the site is not promoted. Corrections are welcome and are recorded as
dated commits, so the edition carries its own revision history.
